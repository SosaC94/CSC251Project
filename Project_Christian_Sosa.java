...
public class Project_Christian_Sosa
{
  ...
  // Constructor
  public Project_Christian_Sosa(int policyNumberA, String providerNameA, String firstNameA, String lastNameA, int ageA, String smokingStatusA, double heightA, double weightA)
  {
